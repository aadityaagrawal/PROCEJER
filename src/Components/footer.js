  ...
  return (
    <footer className="bg-dark text-white text-center text-lg-start px-5 py-3">
      ...
      <div className="d-flex justify-content-between">
        <a className="text-white" href="https://mdbootstrap.com/" style={{fontWeight : "lighter", textDecoration:"none"}}>
          © 2023 Procejer.com
        </a>
        ...
        <div className="d-flex justify-content-between" style={{width : "180px"}}>
          <div>
            <a href="www.facebook.com">
              <img src={facebookLogo} height={"32px"}></img>
            </a>
          </div>
          <div>
            <a href="www.instagram.com">
              <img src={instagramLogo} height={"32px"}></img>
            </a>
          </div>
          <div>
            <a href="www.twitter.com">
              <img src={twitterLogo} height={"32px"} />
            </a>
          </div>
          <div>
            <a href="www.youtube.com">
              <img src={youtubeLogo} height={"32px"}></img>
            </a>
          </div>
        </div>
      </div>
